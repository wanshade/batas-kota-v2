...
import { MapPin, Clock, Calendar, User, Image, ChevronLeft, ArrowRight, CheckCircle2, XCircle, Clock3, AlertCircle, CreditCard, FileText, Info, DollarSign } from "lucide-react"
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-slate-100 flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <h2 className="text-3xl font-light text-slate-900 mb-3">Booking not found</h2>
          <p className="text-slate-600 mb-8 leading-relaxed">The booking you're looking for doesn't exist or you don't have access to it.</p>
          <Link href="/dashboard">
        ...
        <div className="relative h-96 rounded-2xl overflow-hidden mb-16 shadow-2xl group">
          {booking.field.imageUrl ? (
            ...
            <div className="w-full h-full bg-gradient-to-br from-emerald-400 via-emerald-500 to-green-600 flex items-center justify-center">
              <div className="text-center">
                ...
                <div className="text-white/90 text-xl font-light">No field image available</div>
              </div>
            </div>
          )}
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              ...
              <div className="flex items-center gap-6">
                <div className="text-right">
                  <div className="text-3xl font-light text-white mb-1">{formatRupiah(booking.amountPaid)}</div>
                  <div className="text-white/80 text-sm">Amount Paid</div>
                </div>
                <div className={`inline-flex items-center gap-2 px-5 py-3 rounded-full border backdrop-blur-sm bg-white/90 shadow-lg ${statusInfo.color}`}>
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm border border-white/50 hover:shadow-md transition-shadow duration-300">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-2xl font-light text-slate-900">Date & Time</h2>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="flex items-start gap-5">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-50 to-emerald-100 flex items-center justify-center flex-shrink-0 shadow-sm">
                    <Calendar className="w-7 h-7 text-emerald-600" />
                  </div>
                  <div className="space-y-2">
                    <div className="font-medium text-slate-900 text-lg">Date</div>
                ...
                <div className="flex items-start gap-5">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center flex-shrink-0 shadow-sm">
                    <Clock className="w-7 h-7 text-blue-600" />
                  </div>
                  <div className="space-y-2">
                    <div className="font-medium text-slate-900 text-lg">Time</div>
                    <div className="text-slate-600">
            ...
            {booking.proofImageUrl && (
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm border border-white/50 hover:shadow-md transition-shadow duration-300">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <h2 className="text-2xl font-light text-slate-900">Payment Proof</h2>
                </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm border border-white/50 hover:shadow-md transition-shadow duration-300">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-2xl font-light text-slate-900">Field Details</h2>
              </div>
              <div className="space-y-6">
                <div className="flex items-center justify-between py-4 border-b border-slate-100">
                  <span className="text-slate-600 text-lg">Field Name</span>
                  <span className="font-medium text-slate-900 text-lg">{booking.field.name}</span>
                </div>
                <div className="flex items-center justify-between py-4 border-b border-slate-100">
                  <span className="text-slate-600 text-lg">Price per Hour</span>
                  <span className="font-medium text-slate-900 text-lg">{formatRupiah(booking.field.pricePerHour)}</span>
                </div>
                <div className="flex items-center justify-between py-4">
                  <span className="text-slate-600 text-lg font-medium">Total Cost</span>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-emerald-50 to-emerald-100 flex items-center justify-center">
                      <DollarSign className="w-5 h-5 text-emerald-600" />
                    </div>
                    <span className="font-semibold text-xl text-emerald-600">{formatRupiah(totalCost)}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-2xl p-8 shadow-lg border border-emerald-200/50">
              <div className="flex items-center gap-3 mb-8">
                ...
                <h2 className="text-2xl font-light text-slate-900">Payment Summary</h2>
              </div>
              <div className="space-y-4">
                <div className="flex justify-between text-slate-700">
                  <span className="flex items-center gap-2">
                    <Clock className="w-4 h-4" />
                    Field Cost ({duration}h)
                  </span>
                ...
                <div className="flex justify-between font-medium text-emerald-700 text-lg">
                  ...
                  <span>{formatRupiah(booking.amountPaid)}</span>
                </div>
                ...
                <div className="pt-6 border-t border-emerald-200">
                  <div className="flex justify-between font-semibold text-xl text-slate-900">
                    <span>Total</span>
            ...
            {/* Actions Card */}
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm border border-white/50 hover:shadow-md transition-shadow duration-300">
              <h2 className="text-2xl font-light text-slate-900 mb-8">Actions</h2>
              <div className="space-y-4">
                {booking.status === "PENDING" && !booking.proofImageUrl && (
                  <Button asChild className="w-full h-14 bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 text-lg font-medium">
                ...
                <Button variant="outline" asChild className="w-full h-14 rounded-full border-2 border-slate-200 hover:border-emerald-300 hover:bg-emerald-50 transition-all duration-300 text-lg font-medium">
                  <Link href={`/fields/${booking.field.id}`}>
                    <MapPin className="w-5 h-5 mr-2" />
                    View Field Details
                  </Link>
                </Button>
                <Button variant="outline" asChild className="w-full h-14 rounded-full border-2 border-slate-200 hover:border-slate-300 hover:bg-slate-50 transition-all duration-300 text-lg font-medium">
                  <Link href="/dashboard">
                    <ChevronLeft className="w-5 h-5 mr-2" />
                    Back to Dashboard
                  </Link>
            ...
            <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-2xl p-8 border border-slate-200/50 shadow-sm">
              <h2 className="text-2xl font-light text-slate-900 mb-8">Booking Information</h2>
              <div className="space-y-6">
