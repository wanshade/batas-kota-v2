...
export default function RegisterPage() {
  ...
  useEffect(() => {
    ...
    const completedFields = fields.filter(field => formData[field as keyof RegistrationFormData].trim() !== '')
  ...
  const validateField = (field: keyof RegistrationFormData, value: string) => {
    ...
    if (result.success) {
      ...
      const fieldErrors = result.error.issues.filter(issue => issue.path[0] === field)
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 flex items-center justify-center p-4">
        ...
        <div className="w-full max-w-lg relative z-10">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Join Batas Kota</h1>
            <p className="text-gray-600">Create your account and start booking soccer fields</p>
          </div>
              ...
              <form onSubmit={onSubmit} className="space-y-5">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className={`pl-10 transition-colors ${
                        ...
                        isFieldValid('phone') ? 'border-green-500 focus:border-green-500' : ''
                      }`}
                    />
                    {isFieldValid('phone') && (
                      <CheckCircle className="absolute right-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-green-500" />
                  ...
                  {formData.password && (
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs text-gray-600">{passwordStrength.score}%</span>
                      </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    {isFieldValid('confirmPassword') && !getFieldError('confirmPassword') && (
                      <CheckCircle className="absolute right-12 top-1/2 transform -translate-y-1/2 w-5 h-5 text-green-500" />
                    )}
                  </div>
                ...
                >
                  {isLoading ? (
                    <div className="flex items-center gap-2">
                      ...
                      {autoLoginAttempted ? "Creating account and logging in..." : "Creating account..."}
                    </div>
                  ) : (
                    "Create Account"
                  )}
