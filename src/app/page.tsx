...
export default function Home() {
  return (
    ...
    >
      ...
      {/* Why Choose Batas Kota Section - Simple & Clean Design */}
      <section className="py-20 bg-gradient-to-br from-[#EFE9E3] to-[#E1D0B3]">
        <div className="container mx-auto px-6 max-w-4xl">
          {/* Simple Header */}
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#703B3B] mb-6">
              Kenapa Harus Bermain di Batas Kota?
            </h2>
            <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
              Pengalaman Mini Soccer yang lebih seru, nyaman, dan profesional di
              arena terbaik Selong.
            </p>
          </div>

          {/* Clean Content Section */}
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-[#E1D0B3]/20 p-12">
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed mb-8 text-center">
                Batas Kota – The Town Space dirancang khusus untuk memberikan
                pengalaman bermain mini soccer terbaik bagi semua kalangan.
                Dengan fasilitas premium dan lokasi strategis, kami memastikan
                setiap pertandingan menjadi momen yang tak terlupakan.
              </p>

              {/* Simple Numbered List */}
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-8 h-8 bg-[#703B3B] text-white rounded-full flex items-center justify-center font-semibold text-sm">
                    1
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-[#703B3B] mb-2">
                      Lapangan Premium Standar Modern
                    </h3>
                    <p className="text-gray-600 leading-relaxed">
                      Rumput berkualitas tinggi dengan permukaan rata dan
                      pencahayaan optimal, memberikan kenyamanan dan keamanan
                      maksimal untuk permainan siang maupun malam.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Terletak di pusat Selong dengan akses mudah dari berbagai
                      arah, memudahkan Anda dan tim untuk datang tanpa
                      kesulitan, baik untuk pertandingan terjadwal maupun
                      dadakan.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-[#703B3B] mb-2">
                      Fasilitas Lengkap untuk Semua Pemain
                    </h3>
                    <p className="text-gray-600 leading-relaxed">
                      Area istirahat yang nyaman, parkiran luas, ruang ganti,
                      dan layanan booking praktis – semua dirancang untuk
                      mendukung pengalaman bermain yang maksimal dari awal
                      hingga akhir.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-[#703B3B] mb-2">
                      Cocok untuk Fun Match hingga Turnamen
                    </h3>
                    <p className="text-gray-600 leading-relaxed">
                      Fleksibilitas lapangan yang dapat menampung berbagai jenis
                      acara – mulai dari permainan santai bersama teman, latihan
                      rutin tim, hingga turnamen kompetitif berskala komunitas.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-[#703B3B] mb-2">
                      Buka 24 Jam, Siap Kapan Saja
                    </h3>
                    <p className="text-gray-600 leading-relaxed">
                      Jadwal padat bukan lagi kendala. Arena kami beroperasi
                      penuh 24 jam setiap hari, siap melayani kebutuhan bermain
              ...
              <div className="mt-12 pt-8 border-t border-[#E1D0B3]/30">
                <p className="text-center text-gray-700 italic">
                  "Bergabung dengan{" "}
                  <span className="font-semibold text-[#703B3B]">
                    50,000+ pemain
                  </span>{" "}
                  yang telah mempercayai Batas Kota sebagai arena mini soccer
                  pilihan di Selong."
                </p>
              </div>
            </div>
